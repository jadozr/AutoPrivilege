                ...
                return d(l, b), l.include(c), l.include(f), l.include(h), m = function (a) {
                    ...
                    if (null == b && (b = !0), !this.isNotValid(a, !1)) {
                        if (this.renderGMarker(b, function (a) {
                            ...
                            }(this)), this.gMarker && (this.gMarker.getMap() || this.gMarkerManager.type !== j.type))this.deferred.resolve(this.gMarker); else {
        ...
        b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapSearchBoxParentModel", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapEventsHelper", "$timeout", "$http", "$templateCache", function (c, e, f) {
            ...
            return g = function (c) {
                ...
                return d(g, c), g.include(f), g.prototype.init = function () {
                    ...
                    if (b.isUndefined(a.isEmpty))this.$log.error("Error: SearchBoxParentModel setBounds. Bounds not an instance of LatLngBounds."); else if (a.isEmpty() === !1 && null != this.searchBox)return this.searchBox.setBounds(a)
                ...
                return e(i, f), i.include(h), i.prototype.restrict = "EMA", i.prototype.transclude = !0, i.prototype.replace = !1, i.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', i.prototype.scope = {
                    ...
                    return h = [], a.$on("$destroy", function () {
                        ...
                        return function (j) {
                            ...
                            if (p = b.element(e), p.addClass("angular-google-map"), w = {options: {}}, f.options && (w.options = a.options), f.styles && (w.styles = a.styles), f.type && (D = f.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(D) ? w.mapTypeId = google.maps.MapTypeId[f.type.toUpperCase()] : g.error("angular-google-maps: invalid map type '" + f.type + "'")), u = b.extend({}, r, w, {
