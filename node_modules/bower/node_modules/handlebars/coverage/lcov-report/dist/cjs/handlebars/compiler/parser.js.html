...
setInput:function (input) {
        ...
        <span class="skip-if-branch" title="if path not taken">I</span>if (this.options.ranges) <span class="cstat-skip"
                                                                                                      title="statement not covered">this.yylloc.range = [0,0];</span>
        this.offset = 0;
        return this;
    },
...
<span class="cstat-skip" title="statement not covered">        if (this.options.ranges) <span class="cstat-skip"
...
&nbsp;
<span class="cstat-skip" title="statement not covered">        if (lines.length-1) <span class="cstat-skip"
